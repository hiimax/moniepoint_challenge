...
class HomeScreenKeys {
  static const Key circleAvatar = Key('circleAvatar');
  static const Key yourLocation = Key('yourLocation');
  static const Key location = Key('location');
  static const Key notifications = Key('notifications');
  ...
  static const Key availableVehiclesList = Key('availableVehiclesList');
}
